...
Keep responses concise, helpful, and friendly. If asked about features not related to security or the plugin, politely redirect to security topics.";
    ...
    /**
     * Render chatbot HTML in admin dashboard
     */
    public function render_chatbot() {
        // Only render in admin dashboard if chatbot is enabled
        if (!is_admin() || !get_option('kura_ai_chatbot_enabled', false)) {
            return;
        }
        ...
        <div id="kura-ai-chatbot" class="kura-ai-chatbot kura-ai-chatbot-<?php echo esc_attr($position); ?>" style="display: none;">
            ...
            <div class="kura-ai-chatbot-window" id="kura-ai-chatbot-window">
                <div class="kura-ai-chatbot-header">
                    ...
                    <div class="kura-ai-chatbot-controls">
                        <button class="kura-ai-chatbot-reset" id="kura-ai-chatbot-reset" title="Reset Chat">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.65 6.35C16.2 4.9 14.21 4 12 4C7.58 4 4 7.58 4 12C4 16.42 7.58 20 12 20C15.73 20 18.84 17.45 19.73 14H17.65C16.83 16.33 14.61 18 12 18C8.69 18 6 15.31 6 12C6 8.69 8.69 6 12 6C13.66 6 15.14 6.69 16.22 7.78L13 11H20V4L17.65 6.35Z" fill="currentColor"/>
                            </svg>
                        </button>
                        <button class="kura-ai-chatbot-new" id="kura-ai-chatbot-new" title="New Chat">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="kura-ai-chatbot-messages" id="kura-ai-chatbot-messages">
                    ...
                    <div class="kura-ai-preset-prompts" id="kura-ai-preset-prompts">
                        <div class="kura-ai-prompts-title">Quick questions to get started:</div>
                        <div class="kura-ai-prompt-buttons">
                            <button class="kura-ai-prompt-btn" data-prompt="How can I improve my website security?">🔒 How can I improve my website security?</button>
                            <button class="kura-ai-prompt-btn" data-prompt="What are the most common security vulnerabilities?">⚠️ What are common security vulnerabilities?</button>
                            <button class="kura-ai-prompt-btn" data-prompt="How do I set up SSL certificates?">🔐 How do I set up SSL certificates?</button>
                            <button class="kura-ai-prompt-btn" data-prompt="What security plugins do you recommend?">🛡️ What security plugins do you recommend?</button>
                            <button class="kura-ai-prompt-btn" data-prompt="How can I backup my website securely?">💾 How can I backup my website securely?</button>
                        </div>
                    </div>
                </div>
